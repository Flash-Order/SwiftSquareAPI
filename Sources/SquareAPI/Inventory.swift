/// Deprecated version of [RetrieveInventoryAdjustment](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/retrieve-inventory-adjustment) after the endpoint URL is updated to conform to the standard convention.
...
public struct DeprecatedRetrieveInventoryAdjustment: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Deprecated version of [RetrieveInventoryAdjustment](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/retrieve-inventory-adjustment) after the endpoint URL is updated to conform to the standard convention.
		/// - Parameters:
		///   - adjustment_id: ID of the [InventoryAdjustment](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryAdjustment) to retrieve.
...
/// Returns the [InventoryAdjustment](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryAdjustment) object with the provided `adjustment_id`.
...
/// Deprecated version of [BatchChangeInventory](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/batch-change-inventory) after the endpoint URL is updated to conform to the standard convention.
@available(*,deprecated)
...
/// Deprecated version of [BatchRetrieveInventoryChanges](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/batch-retrieve-inventory-changes) after the endpoint URL is updated to conform to the standard convention.
@available(*,deprecated)
...
/// Deprecated version of [BatchRetrieveInventoryCounts](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/batch-retrieve-inventory-counts) after the endpoint URL is updated to conform to the standard convention.
@available(*,deprecated)
...
/// Deprecated version of [RetrieveInventoryPhysicalCount](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/retrieve-inventory-physical-count) after the endpoint URL is updated to conform to the standard convention.
@available(*,deprecated)
public struct DeprecatedRetrieveInventoryPhysicalCount: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Deprecated version of [RetrieveInventoryPhysicalCount](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/retrieve-inventory-physical-count) after the endpoint URL is updated to conform to the standard convention.
		/// - Parameters:
		///   - physical_count_id: ID of the [InventoryPhysicalCount](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryPhysicalCount) to retrieve.
...
/// Returns the [InventoryPhysicalCount](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryPhysicalCount) object with the provided `physical_count_id`.
...
/// Returns the [InventoryTransfer](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryTransfer) object with the provided `transfer_id`.
public struct RetrieveInventoryTransfer: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Returns the [InventoryTransfer](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryTransfer) object with the provided `transfer_id`.
		/// - Parameters:
		///   - transfer_id: (Beta) ID of the [InventoryTransfer](https://developer.squareup.com/reference/square_2022-08-23/objects/InventoryTransfer) to retrieve.
...
public struct RetrieveInventoryCount: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Retrieves the current calculated stock count for a given [CatalogObject](https://developer.squareup.com/reference/square_2022-08-23/objects/CatalogObject) at a given set of [Location](https://developer.squareup.com/reference/square_2022-08-23/objects/Location)s. Responses are paginated and unsorted. For more sophisticated queries, use a batch endpoint.
		/// - Parameters:
		///   - catalog_object_id: ID of the [CatalogObject](https://developer.squareup.com/reference/square_2022-08-23/objects/CatalogObject) to retrieve.
		///   - location_ids: The [Location](https://developer.squareup.com/reference/square_2022-08-23/objects/Location) IDs to look up as a comma-separated list. An empty list queries all locations.
...
/// Returns a set of physical counts and inventory adjustments for the provided [CatalogObject](https://developer.squareup.com/reference/square_2022-08-23/objects/CatalogObject) at the requested [Location](https://developer.squareup.com/reference/square_2022-08-23/objects/Location)s.  You can achieve the same result by calling [BatchRetrieveInventoryChanges](https://developer.squareup.com/reference/square_2022-08-23/inventory-api/batch-retrieve-inventory-changes) and having the `catalog_object_ids` list contain a single element of the `CatalogObject` ID.  Results are paginated and sorted in descending order according to their `occurred_at` timestamp (newest first).  There are no limits on how far back the caller can page. This endpoint can be used to display recent changes for a specific item. For more sophisticated queries, use a batch endpoint.
@available(*,deprecated)
