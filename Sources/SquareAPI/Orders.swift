/// Creates a new [Order](https://developer.squareup.com/reference/square_2021-04-21/objects/Order) which can include information on products for purchase and settings to apply to the purchase.  To pay for a created order, please refer to the  [Pay for Orders](https://developer.squareup.com/docs/orders-api/pay-for-orders) guide.  You can modify open orders using the [UpdateOrder](https://developer.squareup.com/reference/square_2021-04-21/orders-api/update-order) endpoint.
...
/// Retrieves a set of [Order](https://developer.squareup.com/reference/square_2021-04-21/objects/Order)s by their IDs.  If a given Order ID does not exist, the ID is ignored instead of generating an error.
...
/// Search all orders for one or more locations. Orders include all sales, returns, and exchanges regardless of how or when they entered the Square Ecosystem (e.g. Point of Sale, Invoices, Connect APIs, etc).  SearchOrders requests need to specify which locations to search and define a [`SearchOrdersQuery`](https://developer.squareup.com/reference/square_2021-04-21/objects/SearchOrdersQuery) object which controls how to sort or filter the results. Your SearchOrdersQuery can:    Set filter criteria.   Set sort order.   Determine whether to return results as complete Order objects, or as [OrderEntry](https://developer.squareup.com/reference/square_2021-04-21/objects/OrderEntry) objects.  Note that details for orders processed with Square Point of Sale while in offline mode may not be transmitted to Square for up to 72 hours. Offline orders have a `created_at` value that reflects the time the order was created, not the time it was subsequently transmitted to Square.
...
/// Retrieves an [Order](https://developer.squareup.com/reference/square_2021-04-21/objects/Order) by ID.
