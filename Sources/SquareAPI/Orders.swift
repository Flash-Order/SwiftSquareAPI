...
/// Retrieves a set of [orders](https://developer.squareup.com/reference/square_2022-04-20/objects/Order) by their IDs.  If a given order ID does not exist, the ID is ignored instead of generating an error.
...
/// Retrieves an [Order](https://developer.squareup.com/reference/square_2022-04-20/objects/Order) by ID.
