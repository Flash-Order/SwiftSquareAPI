...
public struct ListPayouts: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Retrieves a list of all payouts for the default location.  You can filter payouts by location ID, status, time range, and order them in ascending or descending order.  To call this endpoint, set `PAYOUTS_READ` for the OAuth scope.
		/// - Parameters:
		///   - location_id: (Beta) The ID of the location for which to list the payouts.  By default, payouts are returned for the default (main) location associated with the seller.
		///   - status: (Beta) If provided, only payouts with the given status are returned.
		///   - begin_time: (Beta) The timestamp for the beginning of the payout creation time, in RFC 3339 format. Inclusive. Default: The current time minus one year.
		///   - end_time: (Beta) The timestamp for the end of the payout creation time, in RFC 3339 format. Default: The current time.
		///   - sort_order: (Beta) The order in which payouts are listed.
...
public struct GetPayout: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Retrieves details of a specific payout identified by a payout ID.  To call this endpoint, set `PAYOUTS_READ` for the OAuth scope.
		/// - Parameters:
		///   - payout_id: (Beta) The ID of the payout to retrieve the information for.
...
public struct ListPayoutEntries: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// - Parameters:
		///   - payout_id: (Beta) The ID of the payout to retrieve the information for.
		///   - sort_order: (Beta) The order in which payout entries are listed.
		///   - cursor: (Beta) A pagination cursor returned by a previous call to this endpoint. Provide this cursor to retrieve the next set of results for the original query. For more information, see [Pagination](https://developer.squareup.com/docs/basics/api101/pagination). If request parameters change between requests, subsequent results may contain duplicates or missing records.
		///   - limit: (Beta) The maximum number of results to be returned in a single page. It is possible to receive fewer results than the specified limit on a given page. The default value of 100 is also the maximum allowed value. If the provided value is greater than 100, it is ignored and the default value is used instead. Default: `100`
