...
public struct ListWebhookSubscriptions: SquareAPIEndpoint {
	...
	public struct Params {
		...
		///   - include_disabled: (Beta) Includes disabled [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription)s. By default, all enabled [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription)s are returned.
		///   - sort_order: (Beta) Sorts the returned list by when the [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription) was created with the specified order. This field defaults to ASC.
...
public struct RetrieveWebhookSubscription: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Retrieves a webhook subscription identified by its ID.
		/// - Parameters:
		///   - subscription_id: (Beta) [REQUIRED] The ID of the [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription) to retrieve.
...
public struct UpdateWebhookSubscription: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Updates a webhook subscription.
		/// - Parameters:
		///   - subscription_id: (Beta) [REQUIRED] The ID of the [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription) to update.
		public init(subscription_id: String) {
			self.subscription_id = subscription_id
		}
	}
...
public struct DeleteWebhookSubscription: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Deletes a webhook subscription.
		/// - Parameters:
		///   - subscription_id: (Beta) [REQUIRED] The ID of the [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription) to delete.
		public init(subscription_id: String) {
			self.subscription_id = subscription_id
		}
	}
...
public struct TestWebhookSubscription: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Tests a webhook subscription by sending a test event to the notification URL.
		/// - Parameters:
		///   - subscription_id: (Beta) [REQUIRED] The ID of the [Subscription](https://developer.squareup.com/reference/square_2022-11-16/objects/WebhookSubscription) to test.
		public init(subscription_id: String) {
			self.subscription_id = subscription_id
		}
	}
