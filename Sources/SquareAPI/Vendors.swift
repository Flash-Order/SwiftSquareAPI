/// Creates one or more [Vendor](https://developer.squareup.com/reference/square_yyyy-mm-dd/objects/Vendor) objects to represent suppliers to a seller.
...
/// Retrieves one or more vendors of specified [Vendor](https://developer.squareup.com/reference/square_yyyy-mm-dd/objects/Vendor) IDs.
...
/// Updates one or more of existing [Vendor](https://developer.squareup.com/reference/square_yyyy-mm-dd/objects/Vendor) objects as suppliers to a seller.
...
/// Creates a single [Vendor](https://developer.squareup.com/reference/square_yyyy-mm-dd/objects/Vendor) object to represent a supplier to a seller.
...
/// Searches for vendors using a filter against supported [Vendor](https://developer.squareup.com/reference/square_yyyy-mm-dd/objects/Vendor) properties and a supported sorter.
