/// Creates one or more [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) objects to represent suppliers to a seller.
...
/// Retrieves one or more vendors of specified [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) IDs.
...
/// Updates one or more of existing [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) objects as suppliers to a seller.
...
/// Creates a single [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) object to represent a supplier to a seller.
...
/// Searches for vendors using a filter against supported [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) properties and a supported sorter.
...
/// Retrieves the vendor of a specified [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) ID.
public struct RetrieveVendor: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Retrieves the vendor of a specified [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) ID.
		/// - Parameters:
		///   - vendor_id: (Beta) ID of the [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) to retrieve.
...
/// Updates an existing [Vendor](https://developer.squareup.com/reference/square_2022-08-23/objects/Vendor) object as a supplier to a seller.
