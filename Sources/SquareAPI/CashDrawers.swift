...
/// Provides the summary details for a single cash drawer shift. See [ListCashDrawerShiftEvents](https://developer.squareup.com/reference/square_2021-10-20/cash-drawers-api/list-cash-drawer-shift-events) for a list of cash drawer shift events.
