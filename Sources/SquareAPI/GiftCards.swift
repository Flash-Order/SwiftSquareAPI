...
public struct ListGiftCards: SquareAPIEndpoint {
	...
	public struct Params {
		...
		/// Lists all gift cards. You can specify optional filters to retrieve  a subset of the gift cards. Results are sorted by `created_at` in ascending order.
		/// - Parameters:
		///   - type: If a [type](https://developer.squareup.com/reference/square_2022-11-16/objects/GiftCardType) is provided, the endpoint returns gift cards of the specified type. Otherwise, the endpoint returns gift cards of all types.
		///   - state: If a [state](https://developer.squareup.com/reference/square_2022-11-16/objects/GiftCardStatus) is provided, the endpoint returns the gift cards in the specified state. Otherwise, the endpoint returns the gift cards of all states.
